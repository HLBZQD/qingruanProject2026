...
-- ============================================================================
-- 数据对齐：与 server/db/seed.sql 保持数据完全一致（迁移计划 §10.2）
-- 注意：__BCRYPT_HASH_PLACEHOLDER__ 运行时替换为 bcrypt 哈希值
-- ============================================================================

INSERT INTO users (username, password, role, password_changed) VALUES (
    'admin',
    '__BCRYPT_HASH_PLACEHOLDER__',
    'admin',
    0
);
...
INSERT INTO articles (title, cover, author, content, category, views, summary, tags) VALUES
...
> 以上内容由AI自动生成，仅供参考，不构成医疗诊断或治疗建议。如有健康问题，请及时咨询专业医师。',
 '生活习惯', 1500,
 '血糖监测完整指南，包括监测时间点、正确测量步骤与血糖控制目标',
 '["生活习惯","糖尿病知识科普"]');
